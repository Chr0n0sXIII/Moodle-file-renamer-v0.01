...
public class BasicCase4DataTest {
    ...
    public void initialize() {
        ...
        source += File.separator + "testingData" + File.separator + "basic case_iv" + File.separator + "filesToRename";
    ...
    public void testUnzippingFolder() {
        ...
        assertEquals("sample3 case_iv.zip", zipFolderName);
    ...
    public void testReadingCSV() {
        ...
        String newSource = source + File.separator + "sample3 case_iv";
    ...
    public void testMissingSubmissions() {
        ...
        assertEquals(19, numMissingSubmissions);
    }
