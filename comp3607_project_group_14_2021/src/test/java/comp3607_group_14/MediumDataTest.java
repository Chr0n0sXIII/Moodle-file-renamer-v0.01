...
public class MediumDataTest {
    ...
    public void initialize() {
        ...
        source += File.separator + "testingData" + File.separator + "medium" + File.separator + "filesToRename";
    ...
    public void testUnzippingFolder() {
        ...
        assertEquals("sample1.zip", zipFolderName);
    ...
    public void testReadingCSV() {
        ...
        String newSource = source + File.separator + "sample1";

        String CSVName = folderHandler.getCSVName(newSource);

        assertEquals("Sample 1 CSV.csv", CSVName);
    ...
    public void testFileRenamer() {
        ...
        CSVReader csvReader = new CSVReader(newSource, "Sample 1 CSV.csv");
        csvReader.readCSV();
