...
public class Sample3Test {
    ...
    public void initialize() {
        ...
        source += File.separator + "testingData" + File.separator + "basic" + File.separator + "filesToRename";
    ...
    public void testUnzippingFolder() {
        ...
        assertEquals("sample3.zip", zipFolderName);
    ...
    public void testReadingCSV() {
        ...
        String newSource = source + File.separator + "sample3";
